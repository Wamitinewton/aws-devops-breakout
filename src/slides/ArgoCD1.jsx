  ...
  return (
    <div className="slide">
      ...
      <div className="card" style={{ marginBottom: "1.5rem", borderColor: "rgba(239,123,77,0.3)" }}>
        <div className="card-title"><span style={{ fontSize: "20px" }}>🌿</span> The Four GitOps Principles</div>
      ...
      <div className="two-col" style={{ marginBottom: "1.5rem" }}>
        <div className="card">
          <div className="card-title"><span style={{ fontSize: "20px" }}>⚙️</span> How ArgoCD Works</div>
        ...
        <div className="card">
          <div className="card-title"><span style={{ fontSize: "20px" }}>📊</span> ArgoCD Sync States</div>
          <div className="card-body">
      ...
      {/* ArgoCD vs manual deploy */}
      <div className="card" style={{ marginBottom: "1.5rem" }}>
        <div className="card-title"><span style={{ fontSize: "20px" }}>⚖️</span> ArgoCD vs Manual kubectl apply</div>
